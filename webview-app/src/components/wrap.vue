...
.ask-project-manage-wrap {
    ...
    color: #edf7f7;
    background:
        radial-gradient(circle at 12% 18%, rgba(0, 229, 255, .18), transparent 26%),
        radial-gradient(circle at 86% 8%, rgba(180, 92, 255, .16), transparent 24%),
        linear-gradient(135deg, #101515 0%, #171718 42%, #0c1114 100%);
    ...
    &::before {
        ...
        pointer-events: none;
        background-image:
            linear-gradient(rgba(122, 255, 232, .05) 1px, transparent 1px),
            linear-gradient(90deg, rgba(122, 255, 232, .04) 1px, transparent 1px);
    ...
    .apm-command__sigil {
        ...
        display: grid;
        place-items: center;
        border: 1px solid rgba(115, 255, 232, .35);
        border-radius: 14px;
        background: linear-gradient(145deg, rgba(0, 224, 255, .18), rgba(188, 96, 255, .12));
        box-shadow: 0 0 28px rgba(0, 229, 255, .18), inset 0 0 22px rgba(255, 255, 255, .06);
        color: #8effec;
        font-size: 24px;
    }
    ...
    .apm-command__search {
        :deep(.v-field) {
            border: 1px solid rgba(127, 255, 238, .18);
            border-radius: 14px;
    ...
    .apm-metric {
        min-height: 58px;
        padding: 10px 14px;
        border: 1px solid rgba(159, 255, 236, .14);
        border-radius: 14px;
        background: rgba(10, 18, 20, .54);

        span {
            display: block;
            color: rgba(219, 249, 244, .56);
            font-size: 12px;
        }
    ...
    .apm-metric--active {
        border-color: rgba(232, 94, 255, .24);
        box-shadow: inset 0 0 24px rgba(232, 94, 255, .08);
    }
